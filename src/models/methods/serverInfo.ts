...
type ServerState = "disconnected" | "connected" | "syncing" | "tracking" | "full" | "validating" | "proposing"
...
export interface ServerInfoResponse extends BaseResponse {
    result: {
        info: {
            ...
            closed_ledger?: any // TODO: figure out the shape of this, no docs on xrpl.org
