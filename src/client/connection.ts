 ...
 * @param message
 */
async function websocketSendAsync(ws: WebSocket, message: string) {
...
export class Connection extends EventEmitter {
   ...
   */
  private readonly _heartbeat = async () => {
   ...
   */
  async disconnect(): Promise<number | undefined> {
