...
<aside>
💡 Also, with 3.0, the reference docs have received a massive update to include examples, more readable type information, and properly display documentation on functions which are part of the `Client` class.
</aside>
