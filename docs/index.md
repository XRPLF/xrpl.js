...
*source.* maxAmount | [laxAmount](#amount) | The maximum amount to send. (This field is exclusive with source.amount). Note: maxAmount must be omitted for XRP-to-XRP payments.
