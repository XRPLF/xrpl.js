...
describe('api', () => {
  it('generateSeed - secp256k1', () => {
    expect(api.generateSeed({ entropy })).toEqual(fixtures.secp256k1.seed)
  })
  ...
  it('generateSeed - ed25519', () => {
    expect(api.generateSeed({ entropy, algorithm: 'ed25519' })).toEqual(
  ...
  it('deriveNodeAddress', () => {
    ...
    expect(api.deriveNodeAddress(addrX)).toEqual(addrY)
  })
