...
describe('TransferRate utils', () => {
  ...
  it('Throws when TransferRate >100%', () => {
    assert.throws(
  ...
  it('Throws when TransferRate >1.00', () => {
    assert.throws(
  ...
  it('percentToTransferRate greater than maximum precision', () => {
    assert.throws(
  ...
  it('decimalToTransferRate greater than maximum precision', () => {
    assert.throws(
