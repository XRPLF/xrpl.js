...
describe('Quality utils', () => {
  ...
  it('Throws when decimal Quality greater than maximum precision', () => {
    assert.throws(
  ...
  it('percentToQuality throws with gibberish', () => {
    assert.throws(
  ...
  it('decimalToQuality throws with gibberish', () => {
    assert.throws(
