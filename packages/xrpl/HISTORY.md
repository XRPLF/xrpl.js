...
* Fixed serialize/deserialize verification bug in Wallet.sign() when signing a non-XRP Payment transaction with an amount that contains trailing insignificant zeros
