...
export default <TestSuite>{
  ...
  'sign with lowercase hex data in memo (hex should be case insensitive)': async (client, address) => {
    ...
    assert.deepEqual(result, {
      signedTransaction: '',
      id: '1D0F5DD0F1B6E99A6FD066696F5E2FDE6C253C57A895269E54F3F5CFFA65C7B0'
    })
  },
  ...
  'sign with paths': async (
    ...
    assert.deepEqual(result, {
      signedTransaction: '',
      id: 'A374FD86EF77DC901A6811C3EBCE1A12D4B03ECBF0E3E896A73D3FA7D2D6611B'
    })
    schemaValidator.schemaValidate('sign', result)
  },
  ...
  'succeeds - prepared payment': async (client, address, mockRippled) => {
    ...
    const expectedResult = {
      signedTransaction:
        '',
      id: '34E6B27FB489BD5ACC4BB9D3C20DEB0665FC47005533583396B6BB0BF8059CFF'
    }
